...
const RESUMEN = (process.env.PROJECT_SUMMARY || 'Redes de logistica digital y almacenamiento masivo standalone para Paper (sin Slimefun).').slice(0, 256);
...
if (!proyecto) {
  ...
  const datos = {
    ...
    description: RESUMEN,
    body: cuerpo,
    categories: ['utility', 'technology', 'storage'],
