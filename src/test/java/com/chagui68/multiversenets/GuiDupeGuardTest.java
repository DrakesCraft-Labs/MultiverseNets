...
class GuiDupeGuardTest {
    ...
    @Test
    void accionesPeligrosasQuedanCanceladasEnMenus() {
        ...
        assertTrue(numKey.isCancelled(), "NUMBER_KEY debe ser cancelado");
        ...
        assertTrue(offhand.isCancelled(), "SWAP_OFFHAND debe ser cancelado");

        // 3) DROP (Q) y CONTROL_DROP
        ...
        assertTrue(drop.isCancelled(), "DROP debe ser cancelado");
        ...
        assertTrue(ctrlDrop.isCancelled(), "CONTROL_DROP debe ser cancelado");
        ...
        assertTrue(collect.isCancelled(), "COLLECT_TO_CURSOR / DOUBLE_CLICK debe ser cancelado");

        // 5) MIDDLE (pick block creativo)
        ...
        assertTrue(middle.isCancelled(), "MIDDLE click debe ser cancelado");
    }

    @Test
    void accionesPeligrosasCanceladasEnCellMenuYBarrelMenu() {
        ...
        server.getPluginManager().callEvent(numKey);
        assertTrue(numKey.isCancelled(), "NUMBER_KEY sobre CellMenu debe ser cancelado");
        ...
        server.getPluginManager().callEvent(drop);
        assertTrue(drop.isCancelled(), "DROP sobre BarrelMenu debe ser cancelado");
    }
}
